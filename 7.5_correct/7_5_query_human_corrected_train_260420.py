...
adata_pp = sc.read_h5ad("./output_260420/all_human_corrected_counts_train_pp_3.h5ad")
...
print("save model")
scpoli_model.save("./output_260420/1_model_corrected/all_human_2", overwrite=True)
...
adata_latent_full.write_h5ad("./output_260420/Altas_level1_all_human_umap_nogene_noIAISR_corrected_3.h5ad")
