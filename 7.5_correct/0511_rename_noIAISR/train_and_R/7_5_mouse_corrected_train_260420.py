...
# adata_pp = sc.read_h5ad("./output_mouse/all_mouse_corrected_train_pp.h5ad")
adata_pp = sc.read_h5ad("./output_mouse/all_mouse_corrected_train_pp.h5ad")
...
print("save model")
scpoli_model.save("./output_mouse/all_mouse_model_corrected/", overwrite=True)
...
adata_latent_full.write_h5ad("./output_mouse/Altas_level1_all_mouse_preumap_corrected.h5ad")
print("umap!!!")
...
adata_latent_full.write_h5ad("./output_mouse/Altas_level1_all_mouse_umap_nogene_noIAISR_corrected.h5ad")
