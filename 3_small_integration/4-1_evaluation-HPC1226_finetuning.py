...
print("Writing data..")
bm.plot_results_table(save_dir="./output_1226/evaluation_dim10")
df = bm.get_results(min_max_scale=False)
df.to_csv("./output_1226/evaluation_dim10/results_scIB.csv")
df1 = df.transpose()
df1.to_csv("./output_1226/evaluation_dim10/results_transposed_sciB.csv")
