...
if __name__ == "__main__":
    run_script(
        "3_3_train_py_no_IAISR_0507/3_3_Method260420_noIAISR.py",
        "3_3_train_py_no_IAISR_0507/log/3_3_Method260420_noIAISR.log",
    )

    run_script(
        "3_3_train_py_no_IAISR_0507/4-1_evaluation-HPC260420_noIAISR.py",
        "3_3_train_py_no_IAISR_0507/log/4-1_evaluation-HPC260420_noIAISR.log",
    )
