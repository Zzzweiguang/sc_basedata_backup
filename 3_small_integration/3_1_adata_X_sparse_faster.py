...
adata = sc.read_h5ad("/home/lixiangyu/zr/Annotate/ANNOTATE_new/3_small_integration/output/small-concat-ensembl.h5ad")
...
print(f"保存文件")
adata_agg.write_h5ad("/home/lixiangyu/zr/Annotate/ANNOTATE_new/3_small_integration/output/small-concat-ensembl-aggr-X-py.h5ad")
