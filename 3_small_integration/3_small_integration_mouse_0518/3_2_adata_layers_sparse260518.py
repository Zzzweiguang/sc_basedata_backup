...
adata_agg = sc.read_h5ad(os.path.join(outdir,"mouse-small_concat-ensembl-X.h5ad")) 
adata_agg
...
adata_original = sc.read_h5ad(os.path.join(outdir,"mouse-small_concat-ensembl.h5ad")) 
adata_original
...
adata_agg.write(os.path.join(outdir,"mouse-small_concat-ensembl-agg.h5ad")) 
print(f"处理完成，文件已保存至: {outdir}")
