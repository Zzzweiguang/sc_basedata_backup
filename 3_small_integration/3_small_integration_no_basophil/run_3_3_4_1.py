...
if __name__ == "__main__":
    run_script(
        "3_small_integration_no_basophil/3_3_Method260420_nobasophil.py",
        "3_small_integration_no_basophil/log/3_3_Method260420_nobasophil.log",
    )

    run_script(
        "3_small_integration_no_basophil/4-1_evaluation-HPC260420_nobasophil.py",
        "3_small_integration_no_basophil/log/4-1_evaluation-HPC260420_nobasophil.log",
    )
