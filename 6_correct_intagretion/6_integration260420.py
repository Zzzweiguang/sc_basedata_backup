...
adata = sc.read_h5ad("./output_260420/Atlas_level1-corrected-hvg-preint.h5ad") # for new pipeline with no level 2 with new pdc
adata = adata[adata.obs["dataset"] != "IAISR", :].copy()
print("prepare.....")
...
scpoli_model.save("./output_260420/model_corrected/ref-level1_corrected_dim10", overwrite=True) 
...
scpoli_query.save("./output_260420/model_corrected/query-level1_corrected_dim10", overwrite=True) # with new pdcs
print("Reload")
early_stopping_kwargs = {
    "early_stopping_metric": "val_prototype_loss",
    "mode": "min",
...
scpoli_loaded = scpoli_query.load(dir_path="./output_260420/model_corrected/query-level1_corrected_dim10", adata=adata_query)
...
adata_latent_full.write("./output_260420/Atlas_level1-corrected-hvg-preumap.h5ad")
...
adata_latent_full.write_h5ad("./output_260420/Atlas_level1-corrected-hvg-integrated-noIAISR.h5ad")
