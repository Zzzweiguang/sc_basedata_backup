...
adata_pp = sc.read_h5ad("./output/big-concat-ensembl-nodub-pp.h5ad")
...
scpoli_model.save("./output/ref_model_noBasophil", overwrite=True)
...
adata_latent_full.write_h5ad("./output/big-concat-ensembl-nodub-nogene-preumap.h5ad")
# adata_latent_full.write_h5ad("./output_260420/Altas_level1_measure_preumap.h5ad")

adata_latent_full = sc.read_h5ad("./output/big-concat-ensembl-nodub-nogene-preumap.h5ad")
adata_latent_full

sc.pp.neighbors(adata_latent_full, n_neighbors=15)
sc.tl.umap(adata_latent_full)

adata_latent_full.write_h5ad("./output/big-concat-ensembl-nodub-nogene-umap.h5ad")
print("finished")