...
adata_agg = sc.read_h5ad("/home/lixiangyu/zr/Annotate/ANNOTATE_new/4_big_integration/output/big-concat-ensembl-nodub-aggr-X.h5ad")
...
layers_to_process = ['raw_decontXcounts', 'rounded_corrected_counts','uncorrected_counts']  # 这里替换为你的层名称

# 从原始adata中读取需要处理的层数据（假设原始数据路径不变）
print("读取原始数据以获取需要处理的层...")
adata_original = sc.read_h5ad("/home/lixiangyu/zr/Annotate/ANNOTATE_new/4_big_integration/output/big-concat-ensembl-nodub.h5ad")
...
output_path = "/home/lixiangyu/zr/Annotate/ANNOTATE_new/4_big_integration/output/big-concat-ensembl-nodub-aggr.h5ad"
