...
scpoli_query.save("./output_all_mouse1226/model_1226/mouse-level1", overwrite=True)

print("Create embedding adata")
adata_query = sc.read_h5ad("./output_all_mouse1226/Mouse-aggred-normalized-hvg.h5ad")
scpoli_query = scPoli.load("./output_all_mouse1226/model_1226/mouse-level1", adata=adata_query)
...
print(adata_latent_full)
print("save pre umap")
adata_latent_full.write_h5ad("./output_all_mouse1226/Mouse-aggred-normalized-hvg-integrated-preumap.h5ad")
sc.pp.neighbors(adata_latent_full, n_neighbors=15)
sc.tl.umap(adata_latent_full)
print("save umap ed")
adata_latent_full.write_h5ad("./output_all_mouse1226/Mouse-aggred-normalized-hvg-integrated-nogene.h5ad")
print("finished!!!")