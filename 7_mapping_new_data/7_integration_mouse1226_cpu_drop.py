...
adata_query= sc.read_h5ad("./output_all_mouse1226/Mouse-aggred-normalized-hvg.h5ad")
adata_query = adata_query[adata_query.obs["dataset"] != "GSE245373"].copy()
adata_query.write_h5ad("./output_all_mouse1226/Mouse-aggred-normalized-hvg-drop.h5ad")
scpoli_model = scPoli.load("./output_all_human1226/model_1226/reference_level1", adata=adata_query)
...
##训练过程在/home/lixiangyu/zr/Annotate/ANNOTATE_new/7_mapping_new_data/.py/model_train/mouse.py
print("save query model")
scpoli_query.save("./output_all_mouse1226/model_1226/mouse-level1-drop", overwrite=True)

print("Create embedding adata")
adata_query = sc.read_h5ad("./output_all_mouse1226/Mouse-aggred-normalized-hvg-drop.h5ad")
scpoli_query = scPoli.load("./output_all_mouse1226/model_1226/mouse-level1-drop", adata=adata_query)
adata_query.X = adata_query.X.astype("float32")
results_dict = scpoli_query.classify(adata_query, scale_uncertainties=True)
adata = sc.read_h5ad("./output_all_human1226/Atlas_reference_preint-hvg.h5ad")
...
print(adata_latent_full)
print("save pre umap")
adata_latent_full.write_h5ad("./output_all_mouse1226/Mouse-aggred-normalized-hvg-integrated-preumap-drop.h5ad")
sc.pp.neighbors(adata_latent_full, n_neighbors=15)
sc.tl.umap(adata_latent_full)
print("save umap ed")
adata_latent_full.write_h5ad("./output_all_mouse1226/Mouse-aggred-normalized-hvg-integrated-nogene-drop.h5ad")
print("finished!!!")