...
adata_agg = sc.read_h5ad("./output_all_human260420/merged_aggregated_X.h5ad")
...
layers_to_process = ['raw_decontXcounts','uncorrected_counts']  # 这里替换为你的层名称

# 从原始adata中读取需要处理的层数据（假设原始数据路径不变）
print("读取原始数据以获取需要处理的层...")
adata_original = sc.read_h5ad("./output_all_human260420/human_mergerd_aggpre.h5ad")
...
output_path = "./output_all_human260420/merged_aggregated.h5ad"
