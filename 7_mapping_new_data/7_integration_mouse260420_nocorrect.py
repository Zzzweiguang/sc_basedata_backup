...
adata_query= sc.read_h5ad("./output_all_mouse260420/Mouse-aggred-normalized-hvg-no_correct.h5ad")
scpoli_model = scPoli.load("/home/lixiangyu/zr/Annotate/ANNOTATE_new/4_big_integration/output_260420/model_percorrect/all_measure", adata=adata_query)##没有correct的
...
scpoli_query.save("./output_all_mouse260420/model_260420/mouse-level1-nocorrect", overwrite=True)

print("Create embedding adata")
adata_query = sc.read_h5ad("./output_all_mouse260420/Mouse-aggred-normalized-hvg-no_correct.h5ad")
scpoli_query = scPoli.load("./output_all_mouse260420/model_260420/mouse-level1-nocorrect", adata=adata_query)
adata_query.X = adata_query.X.astype("float32")
results_dict = scpoli_query.classify(adata_query, scale_uncertainties=True)
adata = sc.read_h5ad("/home/lixiangyu/zr/Annotate/ANNOTATE_new/4_big_integration/output_260420/big-concat-ensembl-nodub-aggr-scranlog1p-annot-nodoublets-pp.h5ad")
...
print(adata_latent_full)
print("save pre umap")
adata_latent_full.write_h5ad("./output_all_mouse260420/Mouse-aggred-normalized-hvg-integrated-preumap_nocorrect.h5ad")
sc.pp.neighbors(adata_latent_full, n_neighbors=15)
sc.tl.umap(adata_latent_full)
print("save umap ed")
adata_latent_full.write_h5ad("./output_all_mouse260420/Mouse-aggred-normalized-hvg-integrated-nogene_nocorrect.h5ad")
print("finished!!!")