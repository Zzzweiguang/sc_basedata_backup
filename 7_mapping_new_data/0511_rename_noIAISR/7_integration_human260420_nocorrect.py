...
# scpoli_model = scPoli.load("/home/lixiangyu/zr/Annotate/ANNOTATE_new/4_big_integration/output_260420/model_percorrect/all_measure_no_IAISR", adata=adata_query)###no correct
# print("train query.......")
...
adata_query = sc.read_h5ad("./output_human/mergerd_aggred-log-normalized-hvg-no_correct_2.h5ad")
scpoli_query = scPoli.load("./output_human/model_260507/human_all_query-level1-no_IAISR", adata=adata_query)
...
print("save pre umap")
# adata_latent_full.write_h5ad("./output_human/level1_human_preump_noIAISR_2.h5ad")#####pp-3
sc.pp.neighbors(adata_latent_full, n_neighbors=15)
sc.tl.umap(adata_latent_full)
print("save umap ed")
# adata_latent_full.write_h5ad("./output_human/level1_human_atlas_nogene_noIAISR_2.h5ad")####pp-3
adata_latent_full.write_h5ad("./output_human/level1_human_atlas_nogene_noIAISR_2_no_rename.h5ad")###pp-2
print("finished!!!")