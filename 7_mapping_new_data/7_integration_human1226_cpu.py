...
adata_query= sc.read_h5ad("./output_all_human1226/mergerd_aggred-log-normalized-hvg.h5ad")
...
scpoli_query.save("./output_all_human1226/model_1226/human_all_query-level1", overwrite=True)
print("save finished")


print(" Create embedding adata")
adata_query = sc.read_h5ad("./output_all_human1226/mergerd_aggred-log-normalized-hvg.h5ad")
scpoli_query = scPoli.load("./output_all_human1226/model_1226/human_all_query-level1", adata=adata_query)
...
print("save pre umap")
adata_latent_full.write_h5ad("./output_all_human1226/level1_human_preump.h5ad")
sc.pp.neighbors(adata_latent_full, n_neighbors=15)
sc.tl.umap(adata_latent_full)
print("save umap ed")
adata_latent_full.write_h5ad("./output_all_human1226/level1_human_atlas_nogene.h5ad")
print("finished!!!")