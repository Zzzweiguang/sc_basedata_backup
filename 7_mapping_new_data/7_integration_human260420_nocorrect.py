...
adata_query= sc.read_h5ad("./output_all_human260420/mergerd_aggred-log-normalized-hvg-no_correct.h5ad")
scpoli_model = scPoli.load("/home/lixiangyu/zr/Annotate/ANNOTATE_new/4_big_integration/output_260420/model_percorrect/all_measure", adata=adata_query)###no correct
print("train query.......")
...
scpoli_query.save("./output_all_human260420/model_260420/human_all_query-level1_nocorrect", overwrite=True)
print("save finished")


print(" Create embedding adata")
adata_query = sc.read_h5ad("./output_all_human260420/mergerd_aggred-log-normalized-hvg-no_correct.h5ad")
scpoli_query = scPoli.load("./output_all_human260420/model_260420/human_all_query-level1_nocorrect", adata=adata_query)
...
print(adata_latent_full.obs)
print(adata_latent_full.obs["cell_type_level1_human"])
print("save pre umap")
adata_latent_full.write_h5ad("./output_all_human260420/level1_human_preump_nocorrect.h5ad")
sc.pp.neighbors(adata_latent_full, n_neighbors=15)
sc.tl.umap(adata_latent_full)
print("save umap ed")
adata_latent_full.write_h5ad("./output_all_human260420/level1_human_atlas_nogene_nocorrect.h5ad")
print("finished!!!")