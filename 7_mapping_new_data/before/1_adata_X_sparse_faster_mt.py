...
adata = sc.read_h5ad("output_data/public_data/Mouse_AS_mt/Mouse_aggpre.h5ad")
...
print(f"保存文件")
adata_agg.write_h5ad("output_data/public_data/Mouse_AS_mt/Mouse_aggregated.h5ad")
