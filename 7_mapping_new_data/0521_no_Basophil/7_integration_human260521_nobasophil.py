...
# adata_query= sc.read_h5ad("./output_human/mergerd_aggred-log-normalized-hvg.h5ad")
...
# scpoli_query.save("./output_human/human_model/", overwrite=True)
# print("save finished")


print(" Create embedding adata")
adata_query = sc.read_h5ad("./output_human/mergerd_aggred-log-normalized-hvg.h5ad")
scpoli_query = scPoli.load("./output_human/human_model/", adata=adata_query)
...
print("save pre umap")
adata_latent_full.write_h5ad("./output_human/level1_human_atlas_nogene_preumap.h5ad")
sc.pp.neighbors(adata_latent_full, n_neighbors=15)
sc.tl.umap(adata_latent_full)
print("save umap ed")
adata_latent_full.write_h5ad("./output_human/level1_human_atlas_nogene_umap.h5ad")
print("finished!!!")