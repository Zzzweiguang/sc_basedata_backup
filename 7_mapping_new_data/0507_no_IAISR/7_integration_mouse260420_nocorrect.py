...
# adata_query= sc.read_h5ad("./output_mouse/Mouse-aggred-normalized-hvg-no_correct_2.h5ad")
# scpoli_model = scPoli.load("/home/lixiangyu/zr/Annotate/ANNOTATE_new/4_big_integration/output_260420/model_percorrect/all_measure_no_IAISR", adata=adata_query)##没有correct的
...
# scpoli_query.save("./output_mouse/model_260420/mouse-level1-no_IAISR", overwrite=True)

print("Create embedding adata")
adata_query = sc.read_h5ad("./output_mouse/Mouse-aggred-normalized-hvg-no_correct_2.h5ad")
scpoli_query = scPoli.load("./output_mouse/model_260420/mouse-level1-no_IAISR", adata=adata_query)
adata_query.X = adata_query.X.astype("float32")
results_dict = scpoli_query.classify(adata_query, scale_uncertainties=True)
adata = sc.read_h5ad("/home/lixiangyu/zr/Annotate/ANNOTATE_new/4_big_integration/output_260420/big-concat-ensembl-nodub-aggr-scranlog1p-annot-nodoublets-pp_3.h5ad")
...
print(adata_latent_full)
print("save pre umap")
adata_latent_full.write_h5ad("./output_mouse/Mouse-aggred-normalized-hvg-integrated-preumap_noIAISR_2.h5ad")
sc.pp.neighbors(adata_latent_full, n_neighbors=15)
sc.tl.umap(adata_latent_full)
print("save umap ed")
adata_latent_full.write_h5ad("./output_mouse/Mouse-aggred-normalized-hvg-integrated-nogene_noIAISR_2.h5ad")
print("finished!!!")
