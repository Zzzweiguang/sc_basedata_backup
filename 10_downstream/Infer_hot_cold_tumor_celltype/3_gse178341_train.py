...
adata_query= sc.read_h5ad("./output_0531/GSE178341/GSE178341_postQC_normalized_hvg.h5ad")
...
scpoli_query.save("./model/GSE178341/", overwrite=True)
print("save finished")


print(" Create embedding adata")
adata_query = sc.read_h5ad("./output_0531/GSE178341/GSE178341_postQC_normalized_hvg.h5ad")
scpoli_query = scPoli.load("./model/GSE178341/", adata=adata_query)
...
print("save pre umap")
adata_latent_full.write_h5ad("./output_0531/GSE178341/GSE178341_postQC_normalized_hvg_preumap.h5ad")
sc.pp.neighbors(adata_latent_full, n_neighbors=15)
sc.tl.umap(adata_latent_full)
print("save umap ed")
adata_latent_full.write_h5ad("./output_0531/GSE178341/GSE178341_postQC_normalized_hvg_umap.h5ad")
print("finished!!!")