...
adata_query= sc.read_h5ad("./output_0531/GSE115978/GSE115978_postQC_normalized_hvg.h5ad")
scpoli_model = scPoli.load("/home/lixiangyu/zr/Annotate/ANNOTATE_new/4_big_integration/train_ref_model_noBasophil_0521/output/ref_model_noBasophil/", adata=adata_query)###no correct
print("train query.......")
...
scpoli_query.save("./model/GSE115978/", overwrite=True)
print("save finished")


print(" Create embedding adata")
adata_query = sc.read_h5ad("./output_0531/GSE115978/GSE115978_postQC_normalized_hvg.h5ad")
scpoli_query = scPoli.load("./model/GSE115978/", adata=adata_query)
...
print("save pre umap")
adata_latent_full.write_h5ad("./output_0531/GSE115978/GSE115978_postQC_normalized_hvg_preumap.h5ad")
sc.pp.neighbors(adata_latent_full, n_neighbors=15)
sc.tl.umap(adata_latent_full)
print("save umap ed")
adata_latent_full.write_h5ad("./output_0531/GSE115978/GSE115978_postQC_normalized_hvg_umap.h5ad")
print("finished!!!")